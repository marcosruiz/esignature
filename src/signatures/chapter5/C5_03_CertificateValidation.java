...
public class C5_03_CertificateValidation extends C5_01_SignatureIntegrity {
    public static final String ADOBE = "src/main/resources/abc.crt";
    public static final String CACERT = "src/main/resources/abc.crt";
    public static final String BRUNO = "src/main/resources/abc.crt";
