...
public class C2_06_SignatureAppearance {
    ...
    public static final String IMG = "src/main/resources/icon.png";
	...
	public void sign2(String src, String name, String dest,
        ...
        appearance.setLayer2Font(new Font(BaseFont.createFont("C:/windows/fonts/ariali.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED), 12));
        // Creating the signature
        PrivateKeySignature pks = new PrivateKeySignature(pk, digestAlgorithm, provider);
        ExternalDigest digest = new BouncyCastleDigest();
        MakeSignature.signDetached(appearance, digest, pks, chain, null, null, null, 0, subfilter);
